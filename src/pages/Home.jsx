...
const WORDS = [
  ...
  "Creating Fast & Responsive Web Apps.",
...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, link: "https://www.instagram.com/iqblmp" },
];
        ...
        >
          <div className="px-4 sm:px-6 lg:px-[7%]">
            <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen gap-y-16 lg:gap-16">
              {/* Left Column */}
              <div
                className="w-full lg:w-1/2 space-y-6 sm:space-y-8  lg:text-left "
                data-aos="fade-right"
                data-aos-delay="200"
              >
                <div className="space-y-4 sm:space-y-6">
                  ...
                  {/* Typing Effect */}
                  <div
                    className="h-8 flex items-center  lg:justify-start"
                    data-aos="fade-up"
                    data-aos-delay="800"
                  >
                    <span className="text-lg md:text-2xl bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent">
                      {text}
                    </span>
                  ...
                  <p
                    ...
                    data-aos-delay="1000"
                  >
                    A passionate Frontend Engineer dedicated to creating
                    interactive, fast, and responsive user interfaces.
