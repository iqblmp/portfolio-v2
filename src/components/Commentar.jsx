...
const Comment = memo(({ comment, formatDate, index }) => (
    <div className="px-4 pt-4 pb-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all group hover:shadow-lg hover:-translate-y-0.5 z-10">
...
const Komentar = () => {
    ...
    // bg-gradient-to-b from-white/10 to-white/5 bg-backgrop-blur xl
    return (
        <div className="w-full  rounded-2xl overflow-hidden bg-gradient-to-b from-white/10 to-white/5 shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="space-y-4 h-[300px] overflow-y-auto custom-scrollbar" data-aos="fade-up" data-aos-delay="200">
                    {comments.length === 0 ? (
                        ...
                        comments.map((comment, index) => <Comment key={comment.id} comment={comment} formatDate={formatDate} index={index} />)
                    )}
                </div>
            </div>
            <style jsx>{`
