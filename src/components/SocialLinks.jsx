...
const socialLinks = [
    {
        ...
        subText: "on LinkedIn",
        icon: Linkedin,
        url: "https://www.linkedin.com/in/iqblmp",
        color: "#0A66C2",
    ...
    },
    {
        ...
        subText: "@iqblmp",
        icon: Instagram,
        url: "https://www.instagram.com/iqblmp",
        color: "#E4405F",
    ...
    },
    {
        ...
        subText: "@iqblmp",
        icon: Youtube,
        url: "https://www.youtube.com/@iqblmp",
        color: "#FF0000",
    ...
    },
    {
        ...
        url: "https://tiktok.com/@officialtauru",
        color: "black",
...
const SocialLinks = () => {
    ...
    // backdrop-blur-xl
    return (
        <div className="w-full  rounded-2xl p-6 py-8 bg-gradient-to-br from-white/10 to-white/5 ">
